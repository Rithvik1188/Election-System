...
$password=$_POST['password'];
 ...
 $sql="select type,verification from tbl_users where loginid='$username' and password='$password'";
		...
		session_register("password");
       	header('Location:canmain.php');
                        ...
                        else
                        {
                          ...
                          if($veri=='pending')
                          {
                                                    echo "<p class='normalFont text-primary'><strong>Your Login is Not verified by Admin please Try After Some Time</strong> </p>";
														$s++;
							}
							if($s==0)
							{
