...
$sql6="Select full_name,email,voter_id,type from tbl_users where verification='pending'";
...
$name=strtoupper($myrowc[0]);$email=strtoupper($myrowc[1]);$voterid=strtoupper($myrowc[2]);$type=strtoupper($myrowc[3]);
...
<td> <a href="verificationdone.php?vid=<?php echo $voterid; ?>" onclick="return confirm('Are you sure you want to Verify');"><i class="fas fa-user-times">Verify</i></a></td>
<?php
echo"</tr>";
}
echo "</table>";
