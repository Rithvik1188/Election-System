      ...
      <div class="row">
        <div class="col-sm-12" style="border:2px solid gray;">
          ...
          <div class="page-header">
            <h2 class="specialHead">Candidate Registration Form.</h2>
          ...
          <div class="form-group">
            ...
            <label>Candidate Registered Email ID :</label><br>
            <input type="text" name="voterEmail" placeholder="Enter Your Email ID" class="form-control"/><br>

            <label>Candidate Passport Number:</label><br>
            <input id="id1" type="text" name="voterID"  placeholder="Enter Your Candidate Passport  ID" class="form-control" required/><br>
            ...
            <label>Please Introduce about your self:</label><br>
            <textarea  rows=5 cols=130 name='aboutcan' required></textarea><br><br>
...
$sql6="insert into tbl_users(full_name,email,voter_id,verification,location,type,loginid,password,aboutcan)values('$vname','$vemail','$vid','$v','$location','$type','$loginid','$password','$aboutcan')";
$rs6=mysql_query($sql6) or die(mysql_error());

echo"<br><br><center><font color=green size=4><b><br><br>Candidate Enrolled Sucessfully.. Please Notedown The Login Details<br><br> <center><font color=blue>Generated Username :$loginid   and   Password :$password </font><br><br><center>You have to login after Admin complete the verification Process";
}

if($vi !=0)
{
echo"<center><font color=RED size=4><b>Candidate Already Enrolled";
}
